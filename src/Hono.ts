...
class YelixHono {
  ...
  exposeScalarOpenAPI(params: OpenAPIExposeOptions) {
    ...
    this.__openapi.setTitle(params.title || "API Documentation").setDescription(
      params.description || "API Documentation",
    );
    this.get(
  ...
  private loadEndpointDocs(
    ...
    if (endpointDocs) {
      this.log("debug", "Endpoint docs found", {
        ...
        hasTags: Array.isArray(endpointDocs.tags) &&
          endpointDocs.tags.length > 0,
